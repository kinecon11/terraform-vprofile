resource "aws_elastic_beanstalk_environment" "vprofile-bean-prod" {
  ...
  setting {
    namespace = "aws_elasticbeanstalk:application:environment"
    name      = "environment"
    value     = "prod"
  }
  setting {
  ...
  setting {
    namespace = "aws_elasticbeanstalk:healthreporting:system"
    name      = "SystemType"
    value     = "Basic"
  }
  setting {
    namespace = "aws_autoscaling:updatepolicy:rollingupdate"
    name      = "RollingUpdateEnable"
    value     = "true"
  }
  setting {
    namespace = "aws_autoscaling:updatepolicy:rollingupdate"
